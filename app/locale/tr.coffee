module.exports = nativeDescription: "Türkçe", englishDescription: "Turkish", translation:
  ...
  new_home:
    ...
    gaming_is_good: "Araştırmalar oyun oynamanın çocuğun beyin gelişimi için iyi olduğunu söyler. (Bu doğru!)"
#    game_based: "Oyun tabanlı öğrenme sistemimiz
    compared: "Denetlendi"
    conventional: "Geleneksel değerlendirme metodlarından farkımız açıktır; oyunlarla öğrencilerin konsantrasyon ve bilgiyi özümsemesi daha etkilidir."
#    perform_at_higher_level: "perform at a higher level of achievement"
#    feedback: "Games also provide real-time feedback that allows students to adjust their solution path and understand concepts more holistically, instead of being limited to just “correct” or “incorrect” answers."
    real_game: "Gerçek oyun, kodlarla yazılandır."
